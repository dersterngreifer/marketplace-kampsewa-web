...
<html lang="en">
    ...
    <head>
        ...
        <link href="{{asset('template/envato/lib/owlcarousel/assets/owl.carousel.min.css')}}" rel="stylesheet">
        <link href="{{asset('template/envato/lib/lightbox/css/lightbox.min.css')}}" rel="stylesheet">


        <!-- Customized Bootstrap Stylesheet -->
        <link href="{{asset('template/envato/css/bootstrap.min.css')}}" rel="stylesheet">
