...
<body>
    ...
    <div class="heading">
        ...
        <p class="sub-head">Pelaporan pengeluaran pertahun ini mencakup data tahun yang sudah dipilih pada filter dan list data pengeluaran sekaligus total perbulan pada tahun yang dipilih.</p>
    </div>
    <div class="table">
