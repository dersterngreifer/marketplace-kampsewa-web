    ...
    <div class="max-w-[1400px] mx-auto px-4 sm:px-6 lg:px-8 py-8 w-full flex flex-col gap-8">
        ...
        <div class="bg-blue-50 border border-blue-100 rounded-2xl p-4 flex gap-3 shadow-sm">
            ...
            <div>
                ...
                <p class="text-[13px] font-medium text-blue-700 mt-1">Tekan tombol <strong>Terima</strong> hanya saat pelanggan sudah datang ke lokasi atau saat pengiriman barang dimulai, dengan ketentuan tanggal mulai penyewaan sudah sesuai dengan permintaan pelanggan.</p>
            </div>
        </div>
                    ...
                    <tbody class="divide-y divide-gray-100">
                        @forelse ($data as $item)
                            <tr class="hover:bg-gray-50/50 transition-colors group">
                                ...
                                <td class="px-6 py-4 whitespace-nowrap">
                                    <span class="px-3 py-1.5 rounded-lg text-xs font-bold bg-amber-100 text-amber-700 shadow-sm flex items-center gap-1.5 w-fit">
                                        <span class="w-1.5 h-1.5 rounded-full bg-amber-500 animate-pulse"></span> {{ $item->status_penyewaan }}
                                    </span>
                                </td>
                                <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                                    <a href="{{ route('menu-transaksi.terima-order-masuk', ['id_penyewaan' => Crypt::encrypt($item->id_penyewaan)]) }}"
                                        class="inline-flex items-center justify-center gap-1.5 px-4 py-2 bg-blue-600 text-white font-bold rounded-xl hover:bg-blue-700 hover:shadow-md hover:-translate-y-0.5 transition-all focus:ring-2 focus:ring-blue-500 focus:ring-offset-1">
                            ...
                            <tr>
                                <td colspan="6" class="px-6 py-12 text-center">
                                    <div class="flex flex-col items-center justify-center">
                                        ...
                                        <h4 class="text-base font-bold text-gray-700 mb-1">Belum ada pesanan masuk</h4>
                                        <p class="text-sm text-gray-500">Data pesanan baru akan muncul di sini.</p>
                                    </div>
                                </td>
                            </tr>
                        @endforelse
